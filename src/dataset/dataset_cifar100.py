...
class Cifar100Dataset(Dataset):
    ...
    def __init__(self, train=True, normalize=True, subtract_mean=True, labels_as_logits=True):
        ...
        cifar_dir = os.path.join(this_files_dir, "data", "cifar100")
        ...
        self.dataset = dset.CIFAR100(root=self.data_dir, train=train, transform=trans, download=True)
